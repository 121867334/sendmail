...
class Ext_Reflection {
	 ...
	 * 获取类文档
	 * 
	 * @param mixed $ReflectionClass 类对象 
	 * @return mixed 类文档
	 */
	 ...
	 * 获取属性文档
	 * 
	 * @param mixed $ReflectionProperty 属性对象 
	 * @return mixed 属性文档
	 */
	 ...
	 * 获取方法文档
	 * 
	 * @param mixed $ReflectionMethod 方法对象 
	 * @return mixed 方法文档
	 */
	...
	public function export() {
		Fn::dump(Reflection::export($this->ReflectionClass, true));	
	}
}
