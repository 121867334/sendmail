...
class Request_Input {
	...
	public function __construct ($args = null) {
		$this->controllerName = !empty($args[Fn::$config['controller_var_name']]) ? 
				$args[Fn::$config['controller_var_name']] : Fn::$config['default_controller'];
		$this->actionName = !empty($args[Fn::$config['action_var_name']]) ? 
				$args[Fn::$config['action_var_name']] : Fn::$config['default_action'];
		$this->args = $args;
	}
