...
Fn::$config = array(
	...
	'debug_mode' => false,					// 默认调试模式,上线时设置为false
	...
	'task_php_bin' => '/usr/local/php/bin/php',				// PHP执行路径
